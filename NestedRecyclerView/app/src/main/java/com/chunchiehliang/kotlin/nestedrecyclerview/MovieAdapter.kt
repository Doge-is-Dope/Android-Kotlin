...
import com.chunchiehliang.kotlin.nestedrecyclerview.databinding.ListItemMovieBinding


class MovieAdapter(val onClickListener: MovieListener) :
    ListAdapter<Movie, MovieAdapter.MovieItemViewHolder>(DiffCallback) {
