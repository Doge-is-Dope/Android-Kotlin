...
import com.chunchiehliang.kotlin.materialdesign.network.GdgApiService
import com.chunchiehliang.kotlin.materialdesign.network.GdgChapter
import com.chunchiehliang.kotlin.materialdesign.network.GdgResponse
import com.chunchiehliang.kotlin.materialdesign.network.LatLong
...
class GdgChapterRepository(val gdgApiService: GdgApiService) {
    ...
    private suspend fun doSortData(location: Location? = null): SortedData {
        ...
        val result = coroutineScope {
            ...
            val deferred = async {
                SortedData.from(gdgApiService.getChapters(), location)
            }
